<?php
  ...
  $participantCollegeID=$row['college'];
  $participantPhone=$row['contact'];
  $registrationTimestamp = $row['timestamp'];
  $registrationDeleteStatus = $row['status_del'];
...
<html lang="en">
      ...
      <div class="templatemo-content col-1 light-gray-bg">
        ...
        <div class="templatemo-content-container">
          <div class="templatemo-content-widget white-bg">
            ...
            <form action="web_update.php" class="templatemo-login-form" method="post" enctype="multipart/form-data">
 ...
 <input type="text" class="form-control" name="registration_date_time" value="<?php echo $registrationTimestamp; ?>" disabled />
			  ...
			  <div class="row form-group">
                <div class="col-lg-6 col-md-6 form-group">
                    <label for="inputLoc">Participant Email</label><br>
                     <input type="text" class="form-control" name="participantEmail" value="<?php echo $participantEmail; ?>"  required />
                </div>
                <div class="col-lg-6 col-md-6 form-group">
