...
<!--                <li><a href="visits.php"><i class="fa fa-motorcycle fa-fw"></i>Visits</a></li>-->
                ...
                <li><a href="#" class="active"><i class="fa fa-pencil-square fa-fw"></i>Web Registrations</a></li>
    ...
    <div class="templatemo-content col-1 light-gray-bg">
        ...
        if (isset($_POST['submit_search'])) {
            ...
            $select = "SELECT * FROM register WHERE `status_del` = 0 AND `id` = '" . $searchterm . "'";
//echo $select;
        } else {
            $select = "SELECT * FROM register WHERE `status_del` = 0";
        }
        ...
        if (mysqli_num_rows($result) <= 0) {
            ...
            while ($row = mysqli_fetch_array($result)) {
                ...
                $college = getName("college", "c_id", $college_id, $conn, "c_name");
                ...
                ?>
                <div class="templatemo-content-widget white-bg col-2">
                    <form action="web_edit.php" method="post">
                        <i class="fa fa-times"></i>
                        <div class="square"></div>
                        <h2 class="templatemo-inline-block">Registration ID : <?php echo $id; ?></h2>
                        <br><br>
                        <h3>
                            <table>
                                <tr>
                    ...
                    <br>
                    <td>
                        <form action="web_delete.php" method="POST">
