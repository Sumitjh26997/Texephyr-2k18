...
<head>
  ...
  <meta name="description" content="Biggest science and technology festival of MIT, Pune.
Events of programming, project exhibitions, robotics, RC motor design, robowars, and much more.">

<meta name="keywords" content="MIT Texephyr, Texephyr, Texephyr'18, Texephy 18, Texephyr2k18, Tex18, MIT College Fest, MIT Tech Fest,MIT Pune Tech Fest, MIT Event 2018">

<div hidden itemscope="itemscope" itemtype="http://schema.org/Event">
    <a itemprop="url" href="https://texephyr.in"><span itemprop="name">MIT Texephyr 18</span></a>
    <meta itemprop="startDate" content="2018-03-14T10:00:00Z">03/14/2018 10:00AM
    <div itemprop="location" itemscope="itemscope" itemtype="http://schema.org/Place">
        <a itemprop="url" href="https://texephyr.in"> MIT Texephyr 18 </a>
...
<div hidden itemscope="itemscope" itemtype="http://schema.org/LocalBusiness">
    <span itemprop="name">MIT Texephyr</span>
    <div itemprop="address" itemscope="itemscope" itemtype="http://schema.org/PostalAddress">
        <span itemprop="streetAddress">Kothrud Pune</span>
        <span itemprop="addressLocality">Pune</span>,
        <span itemprop="addressRegion">IN</span>
        <span itemprop="postalCode">411038</span>
        <span itemprop="addressCountry">IN</span>
    </div>
    Phone: <span itemprop="telephone">9766294462</span>
    Website: <a itemprop="URL">https://texephyr.in/</a>
</div>
      ...
      <ul class="cat">
        <li>
          <ol class="type">
            ...
            <li><a href="#" onclick="unhide('6')" >Non-Technical</a></li>
        ...
        <div class="col-sm-6 col-md-3 col-lg-3 web">
          <div class="portfolio-item" style="cursor: pointer">
            ...
            <div class="hover-bg">
              ...
              <img src="img/portfolio/rallymania.jpg" class="img-responsive" alt="Project Title">  </div> </a>
          </div>
        </div>
        <div class="col-sm-6 col-md-3 col-lg-3 app">
          <div class="portfolio-item" style="cursor: pointer">
            ...
            <div class="hover-bg">
              ...
              <img src="img/portfolio/m2.jpg" class="img-responsive" alt="Project Title">  </div> </a>
          </div>
        </div>
        <div class="col-sm-6 col-md-3 col-lg-3 web">
          <div class="portfolio-item" style="cursor: pointer">
            ...
            <div class="hover-bg">
              ...
              <img src="img/portfolio/contraption.jpg" class="img-responsive" alt="Project Title">  </div> </a>
          </div>
        </div>
        <div class="col-sm-6 col-md-3 col-lg-3 web">
          <div class="portfolio-item" style="cursor: pointer">
            ...
            <a onclick="document.getElementById('m4').style.display='block'">
              ...
              <img src="img/portfolio/designerpro.jpg" class="img-responsive" alt="Project Title"> </div> </a>
          </div>
        </div>
...
<p><strong>AREA:</strong></p><br /><p>The area allotted to each team will be 3m x 3m.<br />List of props provided at the event:<br />Thermocol <br />Cardboard<br />Deck of cards<br />Needle<br />Balloon<br />Thread <br />Rubber band<br /> <br />Pop up prop<br />This is the mandatory part. Team has to create a way to conclude their contraption by displaying the name TEXEPHYR. Use your creativity and surprise us. You have to bring your own props for this purpose. For eg. Hoisting a flag with TEXEPHYR on it. <br />Marks are directly proportional to the creativity, so think!<br /><br>
	<p><strong>EVENT GUIDELINES:</strong></p><br />
	The arrangement should complete the contraption in a minimum of 5 steps.<br />A Step is defined as the action that results in another action working towards the final aim of the contraption/machine.<br />Each team will be given 2 trials to show their working arrangement. A setup time of 10 minutes will be given for the second trial.<br />Team has to conclude the contraption with a pop-up prop.<br />A setup time of 2 hours will be given to every team before their first attempt.</p>
<p>All energy conversions are allowed to drive the contraption (including potential, chemical, electrical, kinetic etc.)<br />Once initiated, manual intervention is allowed only when the contraption comes to an unexpected halt. Maximum times the manual intervention allowed is 3.</p>
<br><br><p><strong>JUDGEMENT CRITERIA:</strong></p><br>
<p>Each unique step carries 10 points.<br />Each unique Energy conversion carries 50 points. Thereafter if the energy conversion is repeated the points allotted wsould be half the initial points i.e 25 for the first same conversion and 12.5 for the further repetitions.<br />Each manual intervention made reduces the final score by 15.<br />Completion of the final task gives 100 points to the team.<br />In case of a tie the winner between the two teams will be decided by the time taken by the contraption to complete.</p>
<p>&nbsp;</p>
<p>&nbsp;</p>
<p><strong>ELIGIBILITY CRITERIA: </strong></p>
...
<img src="img/portfolio/b_cricket.jpg">
...
<img src="img/portfolio/b_soccer.jpg">
<p><strong>ELIGIBILITY CRITERIA: </strong></p>
<ul>
<li>Any student with valid ID card of their educational institute can participate.</li>
</ul>
        ...
        <div class="col-sm-6 col-md-3 col-lg-3 web">
          <div class="portfolio-item">
            ...
            <div class="hover-bg">
              ...
              <img src="img/portfolio/roborace.jpg" class="img-responsive" alt="Project Title"> </div></a>
          </div>
        </div>
        <div class="col-sm-6 col-md-3 col-lg-3 app">
          <div class="portfolio-item">
            ...
            <div class="hover-bg">
              ...
              <img src="img/portfolio/circuitrix.jpg" class="img-responsive" alt="Project Title"> </div></a>
          </div>
        </div>
        <div class="col-sm-6 col-md-3 col-lg-3 web">
          <div class="portfolio-item">
            ...
            <div class="hover-bg">
              ...
              <img src="img/portfolio/line_tracer.jpg" class="img-responsive" alt="Project Title"> </div></a>
          </div>
        </div>
        <div class="col-sm-6 col-md-3 col-lg-3 web">
          <div class="portfolio-item">
            ...
            <div class="hover-bg">
              ...
              <img src="img/portfolio/be_project.jpg" class="img-responsive" alt="Project Title"> </div></a>
          </div>
        </div>
        <div class="col-sm-6 col-md-3 col-lg-3 web">
          <div class="portfolio-item">
            ...
            <div class="hover-bg">
              ...
              <img src="img/portfolio/te_project.jpg" class="img-responsive" alt="Project Title"> </div></a>
          </div>
        </div>
...
<p>Registration Fees: 100/-&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Runner-Up: 1,000/-</p>
<p>&nbsp;</p>
...
<div class="container" id="nontech" style="display: none">
        <div class="portfolio-items">
          <div class="col-sm-6 col-md-3 col-lg-3 app">
            <div class="portfolio-item" style="cursor: pointer">
            <a onclick="document.getElementById('m5').style.display='block'">
                ...
                <img src="img/portfolio/paparazzi.jpg" class="img-responsive" alt="Project Title"> </a> </div>
            </div>
          </div>
          <div class="col-sm-6 col-md-3 col-lg-3 app">
          <div class="portfolio-item" style="cursor: pointer">
          <a onclick="document.getElementById('m6').style.display='block'">
              ...
              <img src="img/portfolio/cricket.jpg" class="img-responsive" alt="Project Title"> </a> </div>
          </div>
        </div>
        <div class="col-sm-6 col-md-3 col-lg-3 app">
          <div class="portfolio-item" style="cursor: pointer">
          <a onclick="document.getElementById('m7').style.display='block'">
              ...
              <img src="img/portfolio/soccer.jpg" class="img-responsive" alt="Project Title"> </a> </div>
          </div>
        </div>
        <div class="col-sm-6 col-md-3 col-lg-3 app">
          <div class="portfolio-item" style="cursor: pointer">
          <a onclick="document.getElementById('m8').style.display='block'">
              ...
              <img src="img/portfolio/inquizzitive.jpg" class="img-responsive" alt="Project Title"> </a> </div>
          </div>
        </div>
        <div class="col-sm-6 col-md-3 col-lg-3 app">
          <div class="portfolio-item">
        ...
        <div class="col-sm-6 col-md-3 col-lg-3 web">
          <div class="portfolio-item">
            ...
            <div class="hover-bg">
              ...
              <img src="img/portfolio/ball_wars.jpg" class="img-responsive" alt="Project Title"> </div></a>
          </div>
        </div>
        <div class="col-sm-6 col-md-3 col-lg-3 web">
          <div class="portfolio-item">
            ...
            <div class="hover-bg">
              ...
              <img src="img/portfolio/treasure.jpg" class="img-responsive" alt="Project Title"> </div></a>
          </div>
        </div>
        <div class="col-sm-6 col-md-3 col-lg-3 web">
          <div class="portfolio-item">
            ...
            <div class="hover-bg">
              ...
              <img src="img/portfolio/gaming.jpg" class="img-responsive" alt="Project Title"> </div></a>
          </div>
        </div>
        ...
        <div class="col-sm-6 col-md-3 col-lg-3 web">
          <div class="portfolio-item">
            ...
            <div class="hover-bg">
              ...
              <img src="img/portfolio/python.png" class="img-responsive" alt="Project Title"> </div></a>
          </div>
        </div>
        <div class="col-sm-6 col-md-3 col-lg-3 app">
          <div class="portfolio-item">
            ...
            <div class="hover-bg">
              ...
              <img src="img/portfolio/android.png" class="img-responsive" alt="Project Title"> </div></a>
          </div>
        </div>
        <div class="col-sm-6 col-md-3 col-lg-3 app">
          <div class="portfolio-item">
            <a onclick="document.getElementById('w3').style.display='block'">
            <div class="hover-bg">
              <div class="hover-text">
              ...
              <img src="img/portfolio/imgp.png" class="img-responsive" alt="Project Title"> </div></a>
          </div>
        </div>
        <div class="col-sm-6 col-md-3 col-lg-3 app">
          <div class="portfolio-item">
            <a onclick="document.getElementById('w4').style.display='block'">
            <div class="hover-bg">
              <div class="hover-text">
                <h4>3D Printing</h4>
                <small>Workshop</small>
              ...
              <img src="img/portfolio/3d.png" class="img-responsive" alt="Project Title"> </div></a>
          </div>
        </div>
      </div>
</div>
...
<div id="w3" class="modal">
    <div class="modal-content">
    <span style="float:right;cursor:pointer;" onclick="document.getElementById('w3').style.display='none'">&times;</span><br><br>
    <h2><center>IMAGE PROCESSING USING OPEN CV</center></h2><br><br>
<p><strong>COURSE CONTENT</strong></p>
<p><strong>DAY 1</strong></p>
<p><strong>SESSION 1:</strong></p>
<p><strong>INTRODUCTION:</strong></p>
<ul>
<li >All basics and introduction about Python.</li>
<li >Comparison of various types of software.</li>
<li >The importance of python in today&rsquo;s technology.</li>
</ul>
<p><strong>SESSION 2:</strong></p>
<ul>
<li >The real time applications of python.</li>
<li >Characteristics of python.</li>
<li >Loops and variables.</li>
<li >E-speak.</li>
<li >Security application using camera, capture and send image through SMS ,email using SMTP protocol.</li>
</ul>
<p>&nbsp;</p>
<p>SMALL TASK BASED ON THESE SESSIONS AND QUESTIONS AND ANSWER.</p>
...
<p><strong>SESSION 2:</strong></p>
<ul>
<li >Real time applications useful for project.</li>
<li >Leaf Disease/Traffic Density.</li>
<li >Object tracking/Face Detection Demo</li>
</ul>
<p>SMALL TASK BASED ON THESE SESSIONS AND QUESTIONS AND ANSWER.</p>
<p><br /><br /><br /></p>
  </div>
...
<div id="w4" class="modal">
    <div class="modal-content">
    <span style="float:right;cursor:pointer;" onclick="document.getElementById('w4').style.display='none'">&times;</span><br><br>
    <h2><center>✨ TEXEPHYR'18 and Saa's 3D ✨</center></h2><br /><h2><center>presents</center></h2><br /><h2><center>⚡ 3D PRINTING Workshop ⚡</center></h2><br /> <br /> Imagine🙇💭<br /> Design🎨💻<br /> Print🖨</p>
<p>For students from all the branches 3D printing is an Advanced Manufacturing technique which the future Civil, Mechanical, Electronics, Petroleum &amp; other major industries.</p>
<p>Learn how to make a 3D printer of your own, design for it, image processing, actual printing, problems faced and how to solve them.</p>
<p><b>Participants will get free entry for INQUIZZITIVE event and momentos as well</b></p>
<p><b>Date:</b> 11th-12th March<br /><b>Venue: </b>Department of Mechanical Engineering, MIT KOTHRUD, PUNE<br /><b>Workshop costs:</b> 1100/- for 2 days<br /><b>Limited seats... Register as soon as possible to confirm your seats.</b></p>
<p>For any queries contact<br />Nidhi: 7385699268<br />Pratik: 97645772265</p>
  </div>
</div>
